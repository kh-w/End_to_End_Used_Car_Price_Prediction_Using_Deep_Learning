...
<img src="https://github.com/user-attachments/assets/20b18bf3-64f3-49ae-8caf-a7e962f13d2b" alt="Untitled" width="40%"/>
<img src="https://github.com/user-attachments/assets/9e2c056b-56bc-4cae-b82f-0642c2129d7d" alt="Untitled" width="40%"/>
...
This project successfully developed a deep learning regression model to estimate used car prices under $20,000 based on a dataset collected via web scraping. After thorough data cleaning and preprocessing, the model leveraged a combination of normalized numerical features and word-embedded categorical variables to capture complex relationships within the data.

The deep learning model achieved a RMSE of $2,247.87 and MAE of $1,759.90, the $R^2$ of 0.73 indicates that the model explains 73% of the variance in used car prices, demonstrating strong predictive performance given the complexity and variability inherent in used car markets.

To benchmark against alternative approaches, a Gradient Boosting Regressor was also trained using preprocessed features, including ordinal-encoded high-cardinality categorical variables. This model achieved an RMSE of $1,488.21 and MAE of $1,151.29, the $R^2$ score of 0.89, which is outperforming the deep learning model in both error and variance explained. This highlights that tree-based ensemble methods like Gradient Boosting can offer higher accuracy with less intensive preprocessing, especially on small/moderate size tabular datasets.

These results suggest that embedding techniques for high-cardinality categorical features, combined with a multi-input neural network architecture, are effective strategies for modeling real-world pricing data. However, ensemble methods like Gradient Boosting can be equally or more effective in certain scenarios. There remains room for improvement, especially in reducing prediction error further and capturing more subtle market dynamics.
